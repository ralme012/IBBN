			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#portfolio">Eventos e Projetos</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#team">Diretoria e Liderança</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#contact">Nosso Contato</a>
						</li>
						<li>
